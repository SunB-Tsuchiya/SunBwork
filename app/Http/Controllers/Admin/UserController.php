...
class UserController extends Controller
{
            ...
            $request->validate([
                ...
                'user_role' => [
                    ...
                    function($attribute, $value, $fail) {
                        $allowed = ['admin', 'leader', 'coordinator', 'clerk', 'user'];
    ...
    private function validateAndFixAssignment($assignment, $departmentName)
    {
        // 部署別許可役職
        $validAssignments = [
            '情報出版' => ['管理者', '進行管理', 'オペレーター', '制作', '校正', '営業', 'そのほか'],
            '製版' => ['管理者', '進行管理', 'オペレーター', '制作', 'そのほか'],
            'オンデマンド' => ['管理者', '進行管理', 'オペレーター', '制作', 'そのほか'],
        ];
    ...
    {
        $validUserRoles = ['admin', 'leader', 'coordinator', 'clerk', 'user'];
