<template>
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="z-10 w-3/4 max-w-2xl overflow-auto rounded-lg bg-white shadow-lg" @click.stop>
...
const props = defineProps({ show: Boolean, initialTo: { type: Array, default: () => [] } });
...
const searchByInput = debounce(doSearch, 300);

// when opened, populate initial recipients
watch(
    () => props.show,
    (v) => {
        if (v) {
