...
<template>
    <div class="mb-6">
        <nav class="flex space-x-8" aria-label="Tabs">
            ...
            <Link href="/myjobbox" class="rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-800"> マイジョブ </Link>
            <Link href="/jobbox" class="rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-800"> 依頼されたジョブ </Link>
