        ...
        <div class="py-6">
            <div class="mx-auto max-w-3xl rounded bg-white p-6 shadow sm:px-6 lg:px-8">
                ...
                <div class="mt-6">
                    ...
                    <h3 class="mt-4 font-semibold">管理者コメント</h3>
                    <div v-if="(props.diary.admin_comments || []).length === 0">コメントはありません</div>
                    <div v-for="(c, idx) in props.diary.admin_comments || []" :key="idx" class="mb-2 rounded border p-3">
                        <div class="text-sm text-gray-600">{{ c.admin_name }} - {{ c.created_at }}</div>
