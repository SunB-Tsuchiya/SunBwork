        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
              ...
              <Link :href="route('admin.ai.create')" class="bg-blue-600 text-white px-3 py-2 rounded">新規作成</Link>
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="s in settings.data" :key="s.id" class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm">
                      <Link :href="route('admin.ai.edit', s.id)" class="text-blue-600 hover:text-blue-900">編集</Link>
                    </td>
                  </tr>
                </tbody>
              </table>
