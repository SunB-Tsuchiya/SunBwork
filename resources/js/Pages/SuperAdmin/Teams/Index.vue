                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="team in filteredTeams" :key="team.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap flex flex-col sm:flex-row gap-2 sm:justify-end">
                                    <button @click="() => $inertia.visit(route('superadmin.teams.edit', { team: team.id }))" class="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 text-xs">編集</button>
                                    <button
