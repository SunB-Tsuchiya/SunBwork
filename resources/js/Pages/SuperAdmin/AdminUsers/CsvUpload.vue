...
const submit = () => {
    form.post(route('superadmin.adminusers.csv.preview'));
};
</script>
    ...
    <AppLayout title="CSV一括登録">
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('superadmin.adminusers.create')" class="text-gray-600 hover:text-gray-900">
                    ← 新規ユーザー登録に戻る
                </Link>
            </div>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-between">
                                <Link 
                                    :href="route('superadmin.adminusers.create')"
