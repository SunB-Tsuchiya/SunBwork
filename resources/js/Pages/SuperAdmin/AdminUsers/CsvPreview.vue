...
const submit = () => {
    ...
    console.log('post url:', route('superadmin.adminusers.csv.store'));
    form.post(route('superadmin.adminusers.csv.store'));
};
    ...
    <AppLayout title="CSV登録確認">
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('superadmin.adminusers.csv.upload')" class="text-gray-600 hover:text-gray-900">
                    ← CSVアップロードに戻る
                </Link>
            </div>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="form.users.length === 0" class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        <form :action="route('superadmin.adminusers.csv.upload')" method="get" class="inline">
                            <button type="submit"
