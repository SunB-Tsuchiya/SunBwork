...
const LS_KEY = 'clerk_announcements_yearMonth';
...
const goToShow = (id) => router.visit(route('clerk.announcements.show', { announcement: id }));
</script>
                ...
                <div class="mb-4 space-y-2">
                    <div class="flex max-w-xl gap-2">
                        <input
                            ...
                            class="flex-1 min-w-0 rounded border border-gray-300 px-3 py-2 text-sm focus:border-purple-400 focus:outline-none"
