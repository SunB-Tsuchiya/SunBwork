        ...
        <div class="space-y-6">
            ...
            <div class="rounded-xl border border-orange-100 bg-orange-50 p-5">
                ...
                <ol class="space-y-1 text-sm text-orange-600">
                    ...
                    <li><a href="#teams" class="hover:underline">4. チーム管理</a></li>
                    <li><a href="#diary" class="hover:underline">5. 日報管理</a></li>
                    <li><a href="#workload" class="hover:underline">6. 作業量分析</a></li>
            ...
            <div id="role" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">1</span>
                    リーダーの役割
                </h2>
                ...
                <div class="overflow-hidden rounded-xl border border-gray-100">
                    ...
                    <div class="divide-y divide-gray-100">
                        <div v-for="tab in [
                            ...
                            <span class="w-28 text-xs text-gray-400">{{ tab.cond }}</span>
            ...
            <div id="flow" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">2</span>
                    基本的な使い方の流れ
                </h2>
                <div class="flex flex-wrap items-center gap-2">
                    <div v-for="(step, i) in [
                        ...
                        <span v-if="i < 3" class="text-gray-300 text-xl">→</span>
                    </div>
                </div>
            </div>
            ...
            <div id="users" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-1 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">3</span>
                    ユーザー管理
                </h2>
                <div class="mb-4 text-xs text-orange-500 font-medium">※ 部署リーダーのみ表示</div>
            ...
            <div id="teams" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">4</span>
                    チーム管理
                </h2>
            ...
            <div id="diary" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">5</span>
                    日報管理
                </h2>
                ...
                <div class="mb-5 flex gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-600">
                            ...
                            文章の記録と予定表の記録を同時に把握でき、作業実態を正確に確認できます。
                        </p>
                    </div>
                </div>
            ...
            <div id="workload" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">6</span>
                    作業量分析
                </h2>
                <p class="mb-4 text-gray-600">
            ...
            <div id="workrecord" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">7</span>
                    勤務時間管理
                </h2>
            ...
            <div id="dispatch" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">8</span>
                    派遣管理
                </h2>
                <p class="text-gray-600">
            ...
            <div id="permissions" class="scroll-mt-16 rounded-xl bg-white p-6 shadow-sm">
                <h2 class="mb-4 flex items-center gap-2 text-xl font-bold text-gray-800">
                    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-sm text-orange-600 font-bold">9</span>
                    Leader 権限管理
                </h2>
                <p class="mb-4 text-gray-600">
