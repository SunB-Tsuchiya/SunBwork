...
<template>
    <AppLayout title="Leader Dashboard" :user="user">
        ...
        <!-- ナビゲーションタブ -->
        <LeaderNavigationTabs active="clients" />

        <!-- プロフィール情報表示 -->
        <div class="mb-6 overflow-hidden bg-white p-6 shadow-xl sm:rounded-lg">
            <h3 class="mb-4 text-lg font-medium text-gray-900">オーナープロフィール情報</h3>
        ...
        <div class="mb-6 overflow-hidden bg-orange-50 p-6 shadow-xl sm:rounded-lg">
            <h3 class="mb-4 text-lg font-medium text-orange-900">オーナー専用機能</h3>
